...
export default function Checkout(){
    const {getCartItemsWithProducts, updateQuantity, removeFromCart, getCartTotal, placeOrder} =  useCart()
                        ...
                        {cartItems.map(item=> (
                            <div className="checkout-item" key={item.product.id }>
                                ...
                                <div className="checkout-item-controls">   
                                    ...
                                    <div className="btn btn-secondary btn-small" onClick={()=> removeFromCart(item.product.id)}>
                                        Remove
                                    </div>
